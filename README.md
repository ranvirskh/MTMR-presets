...
- Download [Yandex Music](https://music.yandex.ru/download/) and Telegram client
...
This preset requires "matchAppId" and will not work with the current v.0.27.0 release package. I built the app from the latest source code available in the repo to get the dynamic app items to show/hide.
